...
//     });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("المفضلة",style: Styles().TitleTextStyle16White,),backgroundColor: colors.primary,),

      body: FutureBuilder(

          future:getResponseData().getDataWithToken(url: urls.mylikes,token: widget.token,data: {"token":widget.token,"type":"trainings"}) ,
